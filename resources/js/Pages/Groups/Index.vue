                                ...
                                <div class="container px-6 py-8 mx-auto">
                                    <div class="grid grid-cols-3 gap-4">
                                        <span v-for="lang in languages">
                                            ...
                                            {{ lang.name_ru }}
                                    <img :src="lang.icon_path" width="20px" style="object-fit: contain; display: inline">
                        ...
                        >
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                <div v-if="group.languages.length" class="flex items-center gap-1" v-for="language in group.languages">
                                    ...
                                    <img :src="language.icon_path" width="20px" style="object-fit: contain; display: inline">
